...
(function (MonthlyStartDateAction) {
    MonthlyStartDateAction["NoChange"] = "NoChange";
    MonthlyStartDateAction["Previous"] = "Previous";
    MonthlyStartDateAction["NextWeek"] = "NextWeek";
})(exports.MonthlyStartDateAction || (exports.MonthlyStartDateAction = {}));
(function (weekdaysOrder) {
    weekdaysOrder["SUNDAY"] = "SUNDAY";
    weekdaysOrder["MONDAY"] = "MONDAY";
    weekdaysOrder["TUESDAY"] = "TUESDAY";
    weekdaysOrder["WEDNESDAY"] = "WEDNESDAY";
    weekdaysOrder["THURSDAY"] = "THURSDAY";
...
function getWeekdays(startDateOfWeek) {
    ...
    var weekDaysNames = [
        exports.weekdaysOrder.SUNDAY,
        exports.weekdaysOrder.MONDAY,
        exports.weekdaysOrder.TUESDAY,
        exports.weekdaysOrder.WEDNESDAY,
        exports.weekdaysOrder.THURSDAY,
        exports.weekdaysOrder.FRIDAY,
        exports.weekdaysOrder.SATURDAY,
    ];
...
function week(date, firstDayOfWeek) {
    if (firstDayOfWeek === void 0) { firstDayOfWeek = 1; }
    var xd = new xdate(date, true);
    var before = [];
    var after = [];
...
function getFirstDayOfMonth(date, monthStartDateAction, holidayData) {
    ...
    if (holidayData === void 0) { holidayData = []; }
    if (exports.MonthlyStartDateAction.Previous == monthStartDateAction) {
        if (checkHoliday(date, holidayData)) {
            return getFirstDayOfMonth(date.clone().addDays(-1), monthStartDateAction, holidayData);
        }
    }
    if (exports.MonthlyStartDateAction.NextWeek == monthStartDateAction) {
        if (checkHoliday(date, holidayData)) {
            return getFirstDayOfMonth(date.clone().addDays(1), monthStartDateAction, holidayData);
        }
    }
...
function checkFirstDay(firstDay, monthStartDateAction, holidayData) {
    if (holidayData === void 0) { holidayData = []; }
    // check holiday
...
function setFirstDay(initDate, monthStartDate, monthStartDateAction, holidayData) {
    if (holidayData === void 0) { holidayData = []; }
    var xd = new xdate(initDate, true);
    ...
    if (monthStartDate >= 32) {
        ...
        var maxDayOfFromMonth = numberDayOfMonthYear(firstDay.getMonth() + 1, firstDay.getFullYear());
...
function lastDayOfMonthFromDate(date) {
    ...
    var lastDay = new Date(year, month, days, 0, 0, 0);
    return lastDay;
}
function page(firstDayOfWeek, fromDate, toDate) {
    ...
    var fdow = (7 + firstDayOfWeek) % 7 || 7;
    var ldow = (fdow + 6) % 7;
    var from = new xdate(days[0], true);
    if (from.getDay() !== fdow) {
        from.addDays(-(from.getDay() + 7 - fdow) % 7);
    }
    var to = new xdate(days[days.length - 1], true);
    var day = to.getDay();
    if (day !== ldow) {
        to.addDays((ldow + 7 - day) % 7);
    }
...
function pageWeek(initDate, firstDayOfWeek) {
    if (firstDayOfWeek === void 0) { firstDayOfWeek = 1; }
    firstDayOfWeek = firstDayOfWeek || 0;
    var selectedDay = new Date(initDate);
    var before = [];
    var after = [];
    var fdow = (7 + firstDayOfWeek) % 7 || 7;
    var ldow = (fdow + 6) % 7;
    var from = new xdate(selectedDay, true);
    if (from.getDay() !== fdow) {
        from.addDays(-(from.getDay() + 7 - fdow) % 7);
    }
    var to = new xdate(selectedDay, true);
    var day = to.getDay();
    if (day !== ldow) {
        to.addDays((ldow + 7 - day) % 7);
    }
...
function addDateNumberDate(date, numberAdd) {
    var dateNew = new Date(date);
    dateNew.setDate(dateNew.getDate() + numberAdd);
    return dateNew;
}
function stringFromDateWithFormat(date, format) {
    return new xdate(date, true).toString(format);
}
function getDaysFromDateToDate(dateFrom, dateTo) {
...
function inTimeFromToDate(day, fromDate, toDate) {
    var xd = new xdate(day, true).getTime();
    var xdF = new xdate(fromDate, true).getTime();
    var xdT = new xdate(toDate, true).getTime();
...
exports.addDateNumberDate = addDateNumberDate;
exports.checkFirstDay = checkFirstDay;
...
exports.getKeyMonthFromToDate = getKeyMonthFromToDate;
exports.getStringFromDate = getStringFromDate;
exports.getWeek = getWeek;
exports.getWeekKey = getWeekKey;
exports.getWeekdays = getWeekdays;
exports.inTimeFromToDate = inTimeFromToDate;
exports.isGTE = isGTE;
exports.isLTE = isLTE;
exports.isLeapYear = isLeapYear;
exports.lastDayOfMonthFromDate = lastDayOfMonthFromDate;
exports.numberDayOfMonthYear = numberDayOfMonthYear;
exports.page = page;
exports.pageWeek = pageWeek;
exports.parseDate = parseDate;
exports.parseToMoment = parseToMoment;
exports.parseToXDate = parseToXDate;
exports.sameDate = sameDate;
exports.sameMonth = sameMonth;
exports.setFirstAndLastDay = setFirstAndLastDay;
exports.setFirstDay = setFirstDay;
exports.stringFromDateWithFormat = stringFromDateWithFormat;
exports.sum = sum;
exports.week = week;
