...
export function getDaysOfMonth (
	...
	const {firstDay, lastDay} = setFirstAndLastDay(initDate, monthStartDate, monthStartDateAction, holidayData);
...
export function checkFirstDay (firstDay: XDate, monthStartDateAction: string, holidayData: string[] = []) {
	// check holiday
...
export function setFirstDay (
	...
	if (monthStartDate >= 32) {
		...
		const maxDayOfFromMonth = numberDayOfMonthYear(firstDay.getMonth() + 1, firstDay.getFullYear());
...
export function setFirstAndLastDay (
	...
	const firstDay = setFirstDay(initDate, monthStartDate, monthStartDateAction, holidayData);
...
export function page (firstDayOfWeek = 1, fromDate: string, toDate: string): Date[] {
	firstDayOfWeek = firstDayOfWeek || 0;
...
export function inTimeFromToDate (day: string, fromDate: string, toDate: string) {
